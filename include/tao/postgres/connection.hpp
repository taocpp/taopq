...
namespace tao
{
   namespace postgres
   {
      ...
      public:
         ...
         [[nodiscard]] std::shared_ptr< postgres::transaction > direct();
         [[nodiscard]] std::shared_ptr< postgres::transaction > transaction( const transaction::isolation_level il = transaction::isolation_level::default_isolation_level );
